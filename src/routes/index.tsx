...
export default component$(() => {
  ...
  return (
    <section class="grid h-full gradient-form md:h-full place-items-center">
                ...
                <div class="lg:w-full px-4 md:px-0">
                  <div class="md:p-12 md:mx-6">
                    <div class="text-center">
                      <img
                        class="mx-auto w-48"
                        src="https://res.cloudinary.com/dtb9vkzfa/image/upload/v1673248367/10613791_10180_w4eb6o.jpg"
                        alt="logo"
                      />
